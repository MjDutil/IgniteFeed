...
export function Post({ post } : PostProps) {
    ...
    function deleteComment(CommentToDelete: string) {
         //imutabilidade -> as variaveis não sofrem mutação, nós criamos um novo espaço na memória
            ...
            <div className={styles.content}>
                {post.content.map(line => {
                    if (line.type == 'paragraph') {
                        ...
                        return <p key={line.content} ><a href='#'>{line.content}</a></p>; //key sempre vai ser o primeiro elemento a ser retornado no map
                    }
                })}
            </div>
